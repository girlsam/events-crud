    ...
    .then(function () {
      return Promise.all([
        ...
        knex('events').insert({
          ...
          over_21: 'false',
          start_datetime: '11/02/2016 14:00:00',
          end_datetime: '11/02/2016 15:30:00',
        ...
        knex('events').insert({
          ...
          over_21: 'false',
          start_datetime: '10/30/2016 12:00:00',
          end_datetime: '10/30/2016 14:00:00',
        ...
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '10/31/2016 20:00:00',
          end_datetime: '10/31/2016 23:00:00',
          venue_id: knex('venues').select('id').where('name', 'Steve\'s House')
        }),
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '10/30/2016 16:00:00',
          end_datetime: '10/30/2016 18:00:00',
        ...
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '11/06/2016 19:00:00',
          end_datetime: '11/06/2016 21:00:00',
          venue_id: knex('venues').select('id').where('name', 'US Department of Energy Lab')
        }),
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '11/03/2016 22:00:00',
          end_datetime: '11/04/2016 02:00:00',
          venue_id: knex('venues').select('id').where('name', 'US Department of Energy Lab')
        })
      ]);
    });
