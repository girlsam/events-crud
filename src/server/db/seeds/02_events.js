  ...
  return knex('events').del()
    .then(function () {
      return Promise.all([
        ...
        knex('events').insert({
          title: 'Are Steve Harrington & Jean Ralphio Saperstein Really Related?',
          ...
          over_21: 'false',
          start_datetime: '9/22/2016',
          end_datetime: '9/22/2016'
        }),
        knex('events').insert({
          ...
          over_21: 'false',
          start_datetime: '9/24/2016',
          end_datetime: '9/24/2016'
        }),
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '9/25/2016',
          end_datetime: '9/25/2016'
        }),
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '9/23/2016',
          end_datetime: '9/23/2016'
        }),
        knex('events').insert({
          ...
          over_21: 'true',
          start_datetime: '9/26/2016',
          end_datetime: '9/26/2016'
        }),
        knex('events').insert({
